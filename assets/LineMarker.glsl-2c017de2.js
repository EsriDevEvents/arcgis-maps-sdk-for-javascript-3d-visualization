import{p as d,b as h,i as u,s as g,t as v,o as S,e as y}from"./MarkerSizing.glsl-950a18f6.js";import{t as x,n as z}from"./ForwardLinearDepth.glsl-52bf5bdc.js";import{h as i}from"./Matrix3PassUniform-df6e2166.js";import{u as P}from"./Slice.glsl-cd30f0ea.js";import{o as w}from"./OutputDepth.glsl-17bf0574.js";import{n as $}from"./MultipassTerrainTest.glsl-8b279fcd.js";import{t as b}from"./AlphaCutoff-96178e0d.js";import{e as L,o as D}from"./TransparencyPassType-c3841b0a.js";import{a as N}from"./RgbaFloatEncoding.glsl-67199794.js";import{v as k,d as M,e as T}from"./View.glsl-879c1eaf.js";import{e as O,f as A}from"./Texture2DPassUniform-268e8d2d.js";import{e as m}from"./Float4PassUniform-9354414b.js";import{o as f}from"./FloatPassUniform-0426669b.js";import{o as W,a as r}from"./ShaderBuilder-be7ca791.js";import{O as l}from"./VertexAttribute-15d1866a.js";function j(e){const o=new W,p=e.hasMultipassTerrain&&(e.output===i.Color||e.output===i.Alpha),n=e.space===d.World;e.hasTip&&n&&o.extensions.add("GL_OES_standard_derivatives"),o.include(h,e),o.include(u,e),e.output===i.Depth&&o.include(w,e);const{vertex:a,fragment:c}=o;return c.include(N),k(a,e),o.attributes.add(l.POSITION,"vec3"),o.attributes.add(l.UV0,"vec2"),o.attributes.add(l.AUXPOS1,"vec3"),o.varyings.add("vColor","vec4"),o.varyings.add("vpos","vec3"),o.varyings.add("vUV","vec2"),o.varyings.add("vSize","float"),x(o),p&&o.varyings.add("depth","float"),e.hasTip&&o.varyings.add("vLineWidth","float"),a.uniforms.add([new O("nearFar",(s,t)=>t.camera.nearFar),new m("viewport",(s,t)=>t.camera.fullViewport)]),a.code.add(r`vec4 projectAndScale(vec4 pos) {
