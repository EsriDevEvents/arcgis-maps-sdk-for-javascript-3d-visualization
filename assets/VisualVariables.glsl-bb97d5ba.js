import{a as t}from"./View.glsl-879c1eaf.js";import{K as a,z as n,J as l}from"./VisualVariablePassParameters-f892560d.js";import{a as r}from"./ShaderBuilder-be7ca791.js";import{e as s}from"./Matrix3PassUniform-df6e2166.js";import{O as c}from"./VertexAttribute-15d1866a.js";function z(i,o){o.hasVvInstancing&&(o.vvSize||o.vvColor)&&i.attributes.add(c.INSTANCEFEATUREATTRIBUTE,"vec4");const v=i.vertex;o.vvSize?(v.uniforms.add(new t("vvSizeMinSize",e=>e.vvSizeMinSize)),v.uniforms.add(new t("vvSizeMaxSize",e=>e.vvSizeMaxSize)),v.uniforms.add(new t("vvSizeOffset",e=>e.vvSizeOffset)),v.uniforms.add(new t("vvSizeFactor",e=>e.vvSizeFactor)),v.uniforms.add(new s("vvSymbolRotationMatrix",e=>e.vvSymbolRotationMatrix)),v.uniforms.add(new t("vvSymbolAnchor",e=>e.vvSymbolAnchor)),v.code.add(r`vec3 vvScale(vec4 _featureAttribute) {
