import{x as d}from"./vec3-8818fe1c.js";import{o as i}from"./ScreenSpacePass.glsl-44cc0c5e.js";import{a as u}from"./ReadLinearDepth.glsl-0e6f5c47.js";import{f as p,o as s}from"./Texture2DDrawUniform-e4341b84.js";import{f as m,e as b}from"./Texture2DPassUniform-268e8d2d.js";import{o as v}from"./FloatPassUniform-0426669b.js";import{o as w,a as t}from"./ShaderBuilder-be7ca791.js";const n=4;function _(){const a=new w,r=a.fragment;a.include(i);const f=(n+1)/2,c=1/(2*f*f);return r.include(u),r.uniforms.add([new m("depthMap",e=>e.depthTexture),new p("tex",e=>e.colorTexture),new s("blurSize",e=>e.blurSize),new v("projScale",(e,o)=>{const l=d(o.camera.eye,o.camera.center);return l>5e4?Math.max(0,e.projScale-(l-5e4)):e.projScale}),new b("nearFar",(e,o)=>o.camera.nearFar)]),r.code.add(t`
